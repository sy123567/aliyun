...
MARKET_OPP_COST_LOW_CARGO_THRESHOLD = 3
"""可见货源低于此数量时，机会成本使用降低系数。"""

MARKET_OPP_COST_HIGH_CARGO_THRESHOLD = 15
"""可见货源高于此数量时，机会成本使用提高系数。"""

MARKET_OPP_COST_LOW_RATIO = 0.6
"""货源稀缺时机会成本的缩减比例。"""

MARKET_OPP_COST_HIGH_RATIO = 1.3
"""货源充裕时机会成本的放大比例。"""
